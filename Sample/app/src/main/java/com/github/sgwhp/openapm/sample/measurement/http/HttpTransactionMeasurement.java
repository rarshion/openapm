...
public class HttpTransactionMeasurement extends BaseMeasurement {
    ...
    public HttpTransactionMeasurement(final String url, final String httpMethod, final int statusCode,
                                      final int errorCode, final long startTime, final double totalTime,
                                      final long bytesSent, final long bytesReceived, final String appData) {
    ...
    public String toString() {
        return "HttpTransactionMeasurement{url='" + this.url + '\'' + ", httpMethod='"
                + this.httpMethod + '\'' + ", totalTime=" + this.totalTime
