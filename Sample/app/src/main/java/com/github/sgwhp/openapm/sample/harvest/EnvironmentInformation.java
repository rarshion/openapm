...
public class EnvironmentInformation {
    ...
    public EnvironmentInformation(final long memoryUsage, final int orientation,
                                  final String networkStatus, final String networkWanType, final long[] diskAvailable) {
