...
import com.github.sgwhp.openapm.sample.api.v2.TraceFieldInterface;
import com.github.sgwhp.openapm.sample.api.v2.TraceMachineInterface;
import com.github.sgwhp.openapm.sample.harvest.ActivityHistory;
...
public class TraceMachine extends HarvestAdapter {
    ...
    public static void unloadTraceContext(final Object object) {
        try {
            ...
            if (TraceMachine.threadLocalTrace.get() != null && TraceMachine.log.getLevel() == 4) {
