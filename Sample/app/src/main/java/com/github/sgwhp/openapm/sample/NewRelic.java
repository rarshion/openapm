...
import com.github.sgwhp.openapm.sample.tracing.TracingInactiveException;
import com.github.sgwhp.openapm.sample.util.NetworkFailure;
...
public class NewRelic {
    ...
    public void start(final Context context) {
        ...
        System.out.println("---Rarshion:NewRelic#start---");
        ...
        try {
            ...
            if (!this.isInstrumented()) {
                NewRelic.log.error("Failed to detect New Relic instrumentation. " +
                        " Something likely went wrong during your build process and you should visit http://support.newrelic.com.");
                return;
            }else{
